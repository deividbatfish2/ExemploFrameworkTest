...
public class Read_XLS {
	...
	// Para recuperar Qtd de linhas da Aba do arquivo .xls.
	...
	public String retrieveToRunFlag(String wsName, String colName,
			String rowName) {
	...
	public boolean writeResult(String wsName, String colName, int rowNumber,
			String Result) {
		try {
			int sheetIndex = wb.getSheetIndex(wsName);
			if (sheetIndex == -1)
	...
	public boolean writeResult(String wsName, String colName, String rowName,
			String Result) {
		try {
			int rowNum = retrieveNoOfRows(wsName);
			int rowNumber = -1;
