...
public class SuiteBase {	
	...
	public void init() throws IOException{
		//Para inicializar o serviço de Log.
		Add_Log = Logger.getLogger("rootLogger");				
				
		//Por favor mude os caminhos das strings a baixo se os documentos foram guardados em outra localização.
		//Inicializando o caminho para o arquivo de lista de Suites de teste (TestSuiteList.xls) usando o Construtor da classe Read_XLS Utility.
		TestSuiteListExcel = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\TestSuiteList.xls");
		//Inicializando o caminho para o arquivo Test Suite One(SuiteOne.xls) usando o Construtor da classe Read_XLS Utility.
		TestCaseListExcelOne = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteOne.xls");
		//Inicializando o caminho para o arquivo Test Suite Two(SuiteTwo.xls) usando o Construtor da classe Read_XLS Utility.
		...
		//Inicializando o arquivo Param.properties.
		...
		//Inicializando o arquivo Objects.properties.
	...
	public void loadWebBrowser(){
		//Verifica se qualquer webdriver browser foi previamente instaciado para se existir, rodar os novos testes no mesmo.
			...
			if(Param.getProperty("testBrowser").equalsIgnoreCase("Mozilla")){
				//Para carregar uma instancia do driver Firefox. 
				...
				//Para carregar uma instancia do driver Chrome.
				...
				//Para carregar uma instancia do driver IE.
	...
	public void closeWebBrowser(){
		driver.close();
		//Setar null a instancia do navegador quando este é fechado.
		ExistingchromeBrowser=null;
		ExistingmozillaBrowser=null;
		ExistingIEBrowser=null;
	}
	
	//getElementByXPath função para xpath estático.
	public WebElement getElementByXPath(String Key){
		try{
			//Este bloco irá encontrar os elementos block will find element using Key value from web page and return It.
